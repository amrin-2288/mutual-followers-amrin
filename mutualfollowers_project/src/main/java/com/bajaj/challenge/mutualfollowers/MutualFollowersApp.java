...
public class MutualFollowersApp implements CommandLineRunner {
    ...
    private static final String NAME = "V I AMRIN FATHIMA";
    private static final String REG_NO = "RA2211027010247";
    private static final String EMAIL = "vf1840@srmist.edu.in";
